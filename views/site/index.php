    ...
    <div id="da-slider" class="da-slider">
        ...
        <div class="container">
            ...
            <div class="da-slide">
                ...
                <div class="da-img">
                    <img src="/frontend/images/Slider01.png" alt="image01" width="320">
                </div>
            </div>
            <!-- End first slide -->
            <!-- Start second slide -->
            <div class="da-slide">
                ...
                <a href="#" class="da-link button">Read more</a>
                <div class="da-img">
                    <img src="/frontend/images/Slider02.png" width="320" alt="image02">
                </div>
            </div>
            <!-- End second slide -->
            <!-- Start third slide -->
            <div class="da-slide">
                ...
                <a href="#" class="da-link button">Read more</a>
                <div class="da-img">
                    <img src="/frontend/images/Slider03.png" width="320" alt="image03">
                </div>
            </div>
            <!-- Start third slide -->
...
<div class="section primary-section" id="service">
    <div class="container">
        <!-- Start title section -->
        <div class="title">
            <h1>Магазин тренажеров eurosport.com.ua</h1>
            <!-- Section's title goes here -->
            <p>Большой выбор, индивидуальный подход и правильный подбор каждому</p>
        ...
        <div class="row-fluid">
            <div class="span4">
                <div class="centered service">
                    ...
                    <h3>Коммерческое оборудование</h3>
                    <p>Просчет стоимости проффессиональных тренажеров для залов</p>
                </div>
            </div>
            <div class="span4">
                <div class="centered service">
                    ...
                    <p>Возможность увидеть, протестировать тренажер, перед покупкой.</p>
                </div>
            </div>
            <div class="span4">
                <div class="centered service">
                    ...
                    <p>Пост-гарантийное обслуживание тренажеров ТОЛЬКО своих клиентов</p>
                </div>
            </div>
        </div>
    </div>
...
<!--            </li>-->
        ...
        <div id="single-project">
            <div id="slidingDiv" class="toggleDiv row-fluid single-project">
                <div class="span6">
                    <img src="/frontend/images/Portfolio01.png" alt="project 1" />
                </div>
                <div class="span6">
            ...
            <div id="slidingDiv1" class="toggleDiv row-fluid single-project">
                <div class="span6">
                    <img src="/frontend/images/Portfolio02.png" alt="project 2">
                </div>
                <div class="span6">
                    <div class="project-description">
                        <div class="project-title clearfix">
            ...
            <div id="slidingDiv2" class="toggleDiv row-fluid single-project">
                <div class="span6">
                    <img src="/frontend/images/Portfolio03.png" alt="project 3">
                </div>
                <div class="span6">
                    <div class="project-description">
                        <div class="project-title clearfix">
            ...
            <div id="slidingDiv3" class="toggleDiv row-fluid single-project">
                <div class="span6">
                    <img src="/frontend/images/Portfolio04.png" alt="project 4">
                </div>
                <div class="span6">
                    <div class="project-description">
                        <div class="project-title clearfix">
            ...
            <div id="slidingDiv4" class="toggleDiv row-fluid single-project">
                <div class="span6">
                    <img src="/frontend/images/Portfolio05.png" alt="project 5">
                </div>
                <div class="span6">
                    <div class="project-description">
                        <div class="project-title clearfix">
            ...
            <div id="slidingDiv5" class="toggleDiv row-fluid single-project">
                <div class="span6">
                    <img src="/frontend/images/Portfolio06.png" alt="project 6">
                </div>
                <div class="span6">
                    <div class="project-description">
                        <div class="project-title clearfix">
            ...
            <div id="slidingDiv6" class="toggleDiv row-fluid single-project">
                <div class="span6">
                    <img src="/frontend/images/Portfolio07.png" alt="project 7">
                </div>
                <div class="span6">
                    <div class="project-description">
                        <div class="project-title clearfix">
            ...
            <div id="slidingDiv7" class="toggleDiv row-fluid single-project">
                <div class="span6">
                    <img src="/frontend/images/Portfolio08.png" alt="project 8">
                </div>
                <div class="span6">
                    <div class="project-description">
                        <div class="project-title clearfix">
            ...
            <div id="slidingDiv8" class="toggleDiv row-fluid single-project">
                <div class="span6">
                    <img src="/frontend/images/Portfolio09.png" alt="project 9">
                </div>
                <div class="span6">
                    <div class="project-description">
                        <div class="project-title clearfix">
...
<!--                <div class="thumbnail">-->
<!--                    <img src="/frontend/images/Team1.png" alt="team 1">-->
<!--                    <h3>John Doe</h3>-->
<!--                    <ul class="social">-->
<!--                        <li>-->
<!--                            <a href="">-->
...
<!--                <div class="thumbnail">-->
<!--                    <img src="/frontend/images/Team2.png" alt="team 1">-->
<!--                    <h3>John Doe</h3>-->
<!--                    <ul class="social">-->
<!--                        <li>-->
<!--                            <a href="">-->
...
<!--                <div class="thumbnail">-->
<!--                    <img src="/frontend/images/Team3.png" alt="team 1">-->
<!--                    <h3>John Doe</h3>-->
<!--                    <ul class="social">-->
<!--                        <li>-->
<!--                            <a href="">-->
...
<div id="clients">
    <div class="section primary-section">
        ...
        <div class="container">
            <div class="title">
                <h1>О нас</h1>
                <p>Большой выбор качественных тренажеров, для дома, офиса или тренажерного зала</p>
            </div>
            <div class="row">

            </div>
            <p class="testimonial-text">
                Первый магазин тренажеров в Харькове. Более 15 лет на рынке спортивного оборудования.
            </p>
        </div>
    </div>
</div>
